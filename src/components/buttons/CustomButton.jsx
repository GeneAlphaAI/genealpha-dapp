...
const CustomButton = ({
  ...
  color = "bg-primary-text/2 hover:bg-primary-text/5 ",
  disabled = false,
  loading = false,
  type = "button",
  ...props
  ...
  return (
    <button
      ...
      className={`group text-center ${color}  border-[0.5px] border-stroke-gray  ${mobilePadding} ${defaultPadding} ${roundedStyle} ${
