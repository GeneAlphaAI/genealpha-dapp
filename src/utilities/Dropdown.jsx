  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          ref={triggerRef}
          className={`flex items-center justify-between px-3 py-2 h-[2rem] rounded-sm focus:outline-none ${triggerClassName}`}
        >
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          className={`z-[10000] p-2 rounded-md shadow-lg ${contentClassName}`}
        ...
        >
          {options.map((option) => (
            <DropdownMenu.Item
              ...
              className={`px-2 py-1 text-white outline-0 hover:bg-white/15 transition-color cursor-pointer rounded-sm ${
